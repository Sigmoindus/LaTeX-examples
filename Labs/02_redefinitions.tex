...
\newcommand{\refdraw}[1]{(рис. \ref{#1})}
\newcommand{\refondraw}[1]{на рисунку \ref{#1}}

% Команди для посилань на таблиці
\newcommand{\reftab}[1]{(табл. \ref{#1})}  % Для "(табл. 1)"
\newcommand{\refintab}[1]{в таблиці \ref{#1}}  % Для "в таблиці 1"
