...
\newcommand{\takeFirstSECOND}[1]{%
    ...
    \FirstWord\ \MakeUppercase{\SecondWord}% Print first word and uppercase second word
}

\newcommand{\supervisorFioShort}{
    \takeFirstSECOND{\supervisorFio}
}
\newcommand{\reportAuthorShort}{
    \takeFirstSECOND{\reportAuthor}
}